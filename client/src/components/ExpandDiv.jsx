    ...
    return (
        <>
            <li className='group self-center'>
                ...
                <section className={`max-h-0 flex gap-8 flex-wrap group-hover:max-h-[500px] group-hover:p-8 overflow-hidden transition-none bg-slate-100 absolute right-0 top-20 w-full p-0 rounded-lg`}>
                    {
                        products.map((p,key)=>{
                            return(
                                <>
